  ...
  <section class="container center">
    ...
    <table>
      ...
      <tr>
        ...
        <td class="tablevalue center"> <a id=<?=$produto['produto']?> href="showProduto.php" class="botaomais btn-floating btn-small waves-effect waves-light"><i class="material-icons">add</i></a> </td>
      </tr>
      <?php endforeach;?>
    </table>
